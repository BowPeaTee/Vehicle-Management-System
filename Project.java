...
public class Project {
	...
	public static void main(String[] args) {
		String jdbcurl= "jdbc:postgresql://localhost:5432/car";
		String username="postgres";
		String password="6741";
	...
	private void initialize() {
		...
		btnVehicles.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				String[] columnNames1 = { "Dealer ID", "Username", "Vehicle ID", "Brand", "Model", "Type", "Colour",
						"Year", "Fuel Type", "Price", "Status" };
				...
				btnDisplayVehicles.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						table.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
						table.setDefaultEditor(Object.class, null);
						String[] columnNames1 = { "Dealer ID", "Username", "Vehicle ID", "Brand", "Model", "Type",
								"Colour", "Year", "Fuel Type", "Price", "Status" };
						table.setModel(new DefaultTableModel(columnNames1, vh.Vid.size()));
				...
				BrandcomboBox.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						vh.displaySortedVehicles((String) DealercomboBox.getSelectedItem(),
								(String) BrandcomboBox.getSelectedItem(), (String) TypecomboBox.getSelectedItem(),
								(String) FuelcomboBox.getSelectedItem());
				...
				BrandcomboBox.setModel(new DefaultComboBoxModel<String>(new String[] { "", "Toyota", "Honda", "Ford",
						"Volkswagen", "Nissan", "Chevrolet", "Hyundai", "Renault", "Skoda", "Fiat", "Tata", "Jeep",
						"Ferrari", "Lamborghini", "Bugatti", "BMW", "Maruti", "Tesla" }));
				...
				TypecomboBox.setModel(new DefaultComboBoxModel<String>(
						new String[] { "", "Hatchback", "Sedan", "MPV", "SUV", "Convertible", "Pickup", "Coupe" }));
				...
				FuelcomboBox.setModel(new DefaultComboBoxModel<String>(
						new String[] { "", "Petrol", "Diesel", "Petrol/Diesel", "CNG", "Electric" }));
				...
				btnDealerInfo.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						if (table.getSelectedRow() != -1) {
							...
							JOptionPane.showMessageDialog(null, "Select Dealer from Table.", "No Dealer Selected",
				...
				if (uname.equals("admin") && pass.equals("admin")) {
					...
					Dealerbtn.addActionListener(new ActionListener() {
						...
						public void actionPerformed(ActionEvent e) {
							...
							if (table.getSelectedRow() != -1) {
								...
								int option = JOptionPane.showConfirmDialog(null, "Are you sure?", "Delete Dealer",
								...
								if (option == JOptionPane.YES_OPTION) {
									...
									table.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
									table.setDefaultEditor(Object.class, null);
									String[] columnNames = { "Dealer ID", "Username", "Name", "Region", "Phone",
											"Email" };
									table.setModel(new DefaultTableModel(columnNames, d.Did.size()));
									...
									JOptionPane.showMessageDialog(null, "Dealer Deleted", "Delete Dealer",
											JOptionPane.INFORMATION_MESSAGE);
								}
							} else {
								JOptionPane.showMessageDialog(null, "No Dealer Selected", "Delete Dealer",
										JOptionPane.INFORMATION_MESSAGE);
							}
						}
					});
					...
					Customerbtn.addActionListener(new ActionListener() {
						...
						public void actionPerformed(ActionEvent e) {
							...
							if (table.getSelectedRow() != -1) {
								// DELETE DEALER ACCOUNT
								int option = JOptionPane.showConfirmDialog(null, "Are you sure?", "Delete Customer",
										JOptionPane.YES_NO_OPTION);
								if (option == JOptionPane.YES_OPTION) {
									...
									table.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
									table.setDefaultEditor(Object.class, null);
									String[] columnNames = { "Customer ID", "Username", "Name", "Region", "Phone",
											"Email" };
									table.setModel(new DefaultTableModel(columnNames, d.Did.size()));
								...
								JOptionPane.showMessageDialog(null, "No Customer Selected", "Delete Customer",
										JOptionPane.INFORMATION_MESSAGE);
							}
						}
					});
					...
					Vehiclebtn.addActionListener(new ActionListener() {
						...
						public void actionPerformed(ActionEvent e) {
							...
							if (table.getSelectedRow() != -1) {
								if (JOptionPane.showConfirmDialog(null, "Delete selected vehicle?", "Delete Vehicle",
									...
									table.setDefaultEditor(Object.class, null);
									table.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
									String[] columnNames = { "ID", "Brand", "Model", "Type", "Colour", "Year",
											"Fuel Type", "Price(Rs.)", "Status" };
									...
									scrollPane.setViewportView(table);
									JOptionPane.showMessageDialog(null, "Vehicle deleted.", "Vehicle Deleted",
											JOptionPane.INFORMATION_MESSAGE);
								}
							} else {
								JOptionPane.showMessageDialog(null, "Select Vehicle from Table", "No Vehicle Selected",
										JOptionPane.INFORMATION_MESSAGE);
							}
						}
					});
					...
					comboBox.addActionListener(new ActionListener() {
						...
						public void actionPerformed(ActionEvent arg0) {
							if (comboBox.getSelectedItem().equals("Dealer")) {
								...
								table.setDefaultEditor(Object.class, null);
								table.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
								String[] columnNames = { "ID", "Brand", "Model", "Type", "Colour", "Year", "Fuel Type",
										"Price(Rs.)", "Status" };
								table.setModel(new DefaultTableModel(columnNames, vh.Vid.size()));
					...
					comboBox.setModel(
							new DefaultComboBoxModel<String>(new String[] { "", "Dealer", "Customer", "Vehicle" }));
					...
					JOptionPane.showMessageDialog(null, "Wrong Username/Password.", "Failure",
							JOptionPane.INFORMATION_MESSAGE);
				}
				...
				if (d.loginDealer(uname, pass, vh)) {
						...
						public void actionPerformed(ActionEvent e) {
							...
							btnDeleteVehicle.addActionListener(new ActionListener() {
								...
								public void actionPerformed(ActionEvent e) {
									...
									if (table.getSelectedRow() != -1) {
										if (JOptionPane.showConfirmDialog(null, "Delete selected vehicle?",
												"Delete Vehicle",
												JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
											vh.removeVehicle((String) table.getValueAt(table.getSelectedRow(), 0));
											JOptionPane.showMessageDialog(null, "Vehicle deleted.", "Vehicle Deleted",
										...
										JOptionPane.showMessageDialog(null, "Select Vehicle from Table",
												"No Vehicle Selected", JOptionPane.INFORMATION_MESSAGE);
									}
								}
							});
							...
							yearcomboBox.setModel(new DefaultComboBoxModel<String>(new String[] { "", "2000", "2001",
							...
							JComboBox<String> brandcomboBox = new JComboBox<String>();
							brandcomboBox.setModel(new DefaultComboBoxModel<String>(
									new String[] { "", "Toyota", "Honda", "Ford", "Volkswagen", "Nissan", "Chevrolet",
											"Hyundai", "Renault", "Skoda", "Fiat", "Tata", "Jeep", "Ferrari",
											"Lamborghini", "Bugatti", "BMW", "Maruti", "Tesla" }));
							brandcomboBox.setToolTipText("");
							brandcomboBox.setBounds(295, 84, 117, 22);
							addvehiclepanel.add(brandcomboBox);

							JComboBox<String> typecomboBox = new JComboBox<String>();
							typecomboBox.setModel(new DefaultComboBoxModel<String>(new String[] { "", "Hatchback",
									"Sedan", "MPV", "SUV", "Convertible", "Pickup", "Coupe" }));
							...
							btnAdd.addActionListener(new ActionListener() {
								...
								public void actionPerformed(ActionEvent e) {
									...
									if (brand == "" || model == "" || type == "" || color == "" || year == ""
											|| fuel == "" || price == "") {
										JOptionPane.showMessageDialog(null, "Fill All Details.", "Failure",
												JOptionPane.INFORMATION_MESSAGE);
									} else {
										vh.addVehicle(d.DealerDetails(0), Integer.valueOf(d.DealerDetails(5)), brand,
												model, type, year, color, fuel, price);
										JOptionPane.showMessageDialog(null, "Vehicle Added.", "Success",
												JOptionPane.INFORMATION_MESSAGE);
										modelField.setText("");
										colorField.setText("");
										priceField.setText("");
					...
					btnCustomerRequests.addActionListener(new ActionListener() {
						...
						public void actionPerformed(ActionEvent e) {
							...
							table.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
							table.setDefaultEditor(Object.class, null);
							String[] columnNames = { "Customer ID", "Customer Username", "Vehicle ID", "Vehicle Brand",
									"Vehicle Model", "Price", "Status" };
							table.setModel(new DefaultTableModel(columnNames, vh.Vid.size()));
							...
							btnNewButton_1.addActionListener(new ActionListener() {
								...
								public void actionPerformed(ActionEvent e) {
									if (table.getSelectedRow() != -1) {
										...
										frmVehicleManagementSystem.getContentPane().add(customerinfopanel,
												"name_66305818664800");
										...
										JOptionPane.showMessageDialog(null, "Select Customer from Table.",
												"No Customer Selected", JOptionPane.INFORMATION_MESSAGE);
									}
								}
							});
							btnNewButton_1.setBounds(147, 328, 150, 36);
							...
							btnAcceptRequest.addActionListener(new ActionListener() {
								...
								public void actionPerformed(ActionEvent e) {
									if (table.getSelectedRow() != -1
											&& table.getValueAt(table.getSelectedRow(), 6).equals("Pending")) {
										int option = JOptionPane.showConfirmDialog(null, "Accept Offer?",
												"Manage Requests", JOptionPane.YES_NO_CANCEL_OPTION);
										if (option == JOptionPane.YES_OPTION) {
											...
											table.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
											table.setDefaultEditor(Object.class, null);
											String[] columnNames = { "Customer ID", "Customer Username", "Vehicle ID",
													"Vehicle Brand", "Vehicle Model", "Price", "Status" };
											table.setModel(new DefaultTableModel(columnNames, vh.Vid.size()));
											...
											scrollPane.setViewportView(table);
											JOptionPane.showMessageDialog(null, "Offer Accepted.", "Accepted",
													JOptionPane.INFORMATION_MESSAGE);
										}

										else if (option == JOptionPane.NO_OPTION) {

											vh.denyRequest(d.DealerDetails(0), Integer
													.parseInt((String) table.getValueAt(table.getSelectedRow(), 2)));
											vh.requestDetails(d.DealerDetails(0));
											table.removeAll();
											table = new JTable();
											table.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
											...
											JOptionPane.showMessageDialog(null, "Offer Rejected.", "Denied",
													JOptionPane.INFORMATION_MESSAGE);
										}
									} else if (table.getSelectedRow() == -1) {
										JOptionPane.showMessageDialog(null, "Select Request from Table.",
												"No Request Selected", JOptionPane.INFORMATION_MESSAGE);
									} else {
										JOptionPane.showMessageDialog(null, "Request already Accepted/Denied.",
					...
					btnDeleteAccount.addActionListener(new ActionListener() {
						...
						public void actionPerformed(ActionEvent e) {
							...
							// DELETE DEALER ACCOUNT
							int option = JOptionPane.showConfirmDialog(null, "Are you sure?", "Delete Account",
									JOptionPane.YES_NO_OPTION);
							if (option == JOptionPane.YES_OPTION) {
		...
		comboBoxDNRegion.setModel(new DefaultComboBoxModel<String>(
				new String[] { "", "Mumbai City", "Mumbai Suburban", "Thane", "Palghar", "Raigad", "Ratnagiri",
						"Sindhudurg", "Kolhapur", "Pune", "Sangli", "Satara", "Solapur" }));
		...
		btnDNRegister.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (uname.equals("") || pass.equals("") || name.equals("") || region.equals("") || phone.equals("")
						|| email.equals("")) {
					JOptionPane.showMessageDialog(null, "Fill All Entries.", "Failure",
							JOptionPane.INFORMATION_MESSAGE);
				} else if (d.checkDUsername(uname)) {
					JOptionPane.showMessageDialog(null, "Username Already Taken.", "Failure",
							JOptionPane.INFORMATION_MESSAGE);
				} else {
					d.addDealer(uname, pass, name, region, phone, email);
					JOptionPane.showMessageDialog(null, "New Account Created.", "Success",
							JOptionPane.INFORMATION_MESSAGE);
				...
				if (cs.loginCustomer(uname, pass, vh)) {
						...
						public void actionPerformed(ActionEvent arg0) {
							...
							btnDisplayVehicles.addActionListener(new ActionListener() {
								...
								public void actionPerformed(ActionEvent e) {
									...
									table.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
									table.setDefaultEditor(Object.class, null);
									String[] columnNames1 = { "Dealer ID", "Username", "Vehicle ID", "Brand", "Model",
											"Type", "Colour", "Year", "Fuel Type", "Price", "Status" };
									table.setModel(new DefaultTableModel(columnNames1, vh.Vid.size()));
								...
								public void actionPerformed(ActionEvent e) {
									if (table.getSelectedRow() != -1) {
										try {
											...
											if (JOptionPane.showConfirmDialog(null, "Place Order?", "Order",
													JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
												vh.buyVehicle(
														Integer.parseInt(
																(String) table.getValueAt(table.getSelectedRow(), 2)),
														cs.CustomerDetails(0), Integer.parseInt(cs.CustomerDetails(5)));
												vh.displayAllVehicles();
												...
												table.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
												table.setDefaultEditor(Object.class, null);
												String[] columnNames1 = { "Dealer ID", "Username", "Vehicle ID",
														"Brand", "Model", "Type", "Colour", "Year", "Fuel Type",
														"Price", "Status" };
												table.setModel(new DefaultTableModel(columnNames1, vh.Vid.size()));
												...
												scrollPane_1.setViewportView(table);
												JOptionPane.showMessageDialog(null, "Order Placed.", "Incorrect Table",
														JOptionPane.INFORMATION_MESSAGE);
											}

										} catch (NumberFormatException e1) {
											JOptionPane.showMessageDialog(null, "Switch to Vehicle Table.",
													"Incorrect Table", JOptionPane.INFORMATION_MESSAGE);
										}
							...
							btnDealerInfo.addActionListener(new ActionListener() {
								...
								public void actionPerformed(ActionEvent e) {
									if (table.getSelectedRow() != -1) {
										...
										JPanel dealerinfopanel = new JPanel();
										dealerinfopanel.setLayout(null);
										frmVehicleManagementSystem.getContentPane().add(dealerinfopanel,
												"name_66305818664800");
										...
										JOptionPane.showMessageDialog(null, "Select Dealer from Table.",
												"No Dealer Selected", JOptionPane.INFORMATION_MESSAGE);
									}
								}
							});
							btnDealerInfo.setBounds(354, 328, 160, 50);
					...
					btnOrders.addActionListener(new ActionListener() {
						...
						public void actionPerformed(ActionEvent arg0) {
							...
							table.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
							table.setDefaultEditor(Object.class, null);
							String[] columnNames = { "Dealer ID", "Dealer Username", "Vehicle ID", "Vehicle Brand",
									"Vehicle Model", "Price", "Status" };
							table.setModel(new DefaultTableModel(columnNames, vh.Vid.size()));
								...
								public void actionPerformed(ActionEvent e) {
									if (table.getSelectedRow() != -1
											&& ((String) table.getValueAt(table.getSelectedRow(), 6))
													.equals("Pending")) {
										int option = JOptionPane.showConfirmDialog(null, "Cancel Order?",
												"Manage Orders", JOptionPane.YES_NO_OPTION);
										if (option == JOptionPane.YES_OPTION) {
											String ID = (String) table.getValueAt(table.getSelectedRow(), 2);
											...
											table.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
											table.setDefaultEditor(Object.class, null);
											String[] columnNames = { "Dealer ID", "Dealer Username", "Vehicle ID",
													"Vehicle Brand", "Vehicle Model", "Price", "Status" };
											table.setModel(new DefaultTableModel(columnNames, vh.Vid.size()));
											...
											scrollPane.setViewportView(table);
											JOptionPane.showMessageDialog(null, "Order Cancelled.", "Cancelled",
													JOptionPane.INFORMATION_MESSAGE);
										}
									} else if (table.getSelectedRow() == -1) {
										...
										JOptionPane.showMessageDialog(null, "Order already Placed", "Already Done",
												JOptionPane.INFORMATION_MESSAGE);
									}
								}
							});
		...
		CNRegioncomboBox.setModel(new DefaultComboBoxModel<String>(
				new String[] { "", "Mumbai City", "Mumbai Suburban", "Thane", "Palghar", "Raigad", "Ratnagiri",
						"Sindhudurg", "Kolhapur", "Pune", "Sangli", "Satara", "Solapur" }));
